...
public class pnReportePasajeros extends javax.swing.JPanel {
    ...
    private void initGraph(){
        ...
        data.setValue(vtSistemaAeoropuerto.getAeropuertoUIS().pasajerosPorEdad()[0], "Mayores de Edad",""); 
        data.setValue(vtSistemaAeoropuerto.getAeropuertoUIS().pasajerosPorEdad()[1], "Menores de Edad","");
